...
import com.wzz.pojo.ProductInfo;
import com.wzz.pojo.vo.ProductInfoVo;
import com.wzz.service.ProductInfoService;
import com.wzz.utils.FileNameUtil;
...
public class ProductInfoAction {
    ...
    public void ajaxSplit2(ProductInfoVo vo, HttpSession session) {
        //取得当前page参数的页面的数据
        PageInfo info = productInfoService.splitPageVo(vo,PAGE_SIZE);
        session.setAttribute("info", info);
    }
    ...
    public void condition2(ProductInfoVo vo, HttpSession session){
        List<ProductInfo> list = productInfoService.selectCondition(vo);
        session.setAttribute("list",list);
    }
