...
<html>
	...
	<body>
		<div id="login">
			<div id="top">
				<img src="${pageContext.request.contextPath}/images/cloud.jpg" /><span>用户登入</span>
			</div>
			<div id="bottom">
					...
					<table border="0px" id="table">
						...
						<tr>
							...
							<td><input type="submit" value="登录" class="td3">
								<a href="${pageContext.request.contextPath}/admin/regist2.jsp"><input type="button" value="注册" class="td3	"></a>
							</td>
						</tr>
					</table>
				</form>
