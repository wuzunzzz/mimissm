				...
				<div id="bleft">
					...
					<div id="lbottom">
						<ul>
							...
							<a href="${pageContext.request.contextPath}/order/split.action" target="myright">
							...
							<a href="${pageContext.request.contextPath}/user/split.action" target="myright">
							...
							<a href="${pageContext.request.contextPath}/announce/split.action" target="myright">
